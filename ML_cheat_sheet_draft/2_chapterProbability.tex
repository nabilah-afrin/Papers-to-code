...
% can take on any value from a finite or countably infinite set.
...
\bengalifont
\begin{itemize}
    \item $  P(X \leq x) $ $X$ -{\bengalifont এর মান} $x$-{\bengalifontএর কম বা সমান হওয়ার সম্ভাবনা।}
...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
% \textbf{{\bengali উদাহরণ} }
% {\bengali যদি আপনি একটি ৬-পাশের Dais গড়ান, তাহলে PMF হবে:}

% \[
% p(x) =
% \begin{cases} 
% \frac{1}{6}, & {\bengaliযদি } x = 1, 2, 3, 4, 5, 6 \\ 
% 0, & {\bengaliঅন্যান্য ক্ষেত্রে}
% \end{cases}
% \]
%     o9
...
\begin{itemize} 
    ...
    \item $P(X \mid Y)$ {\bengalifont বোঝায়} $Y$ {\bengalifontঘটে যাওয়ার শর্তে,} $X$ {\bengalifont ঘটার সম্ভাবনা} 
...
% Why double summation/integration? The CDF involves accumulating the probabilities or densities over a region (up to the given values 
% 𝑥
% x and 
% 𝑦
% y), so you need to sum or integrate over both variables.
